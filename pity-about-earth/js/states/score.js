class ScoreState extends Phaser.State {
  ...
  create() {
    ...
    if (this.stats.transportsLaunched === 0) {
      ...
      this.previousMusic.fadeOut(100);
      this.music.fadeIn(100, true);
      this.story = [`Well done, you saved ${score}`, `people.  Humanity is probably`, `still doomed, but the survivors`, `will have a nice retirement. ` // `The universe, growing tired of`,
    ...
    const btnHum = game.add.button(game.world.centerX, game.world.height - 130, 'btn-play', this.next, this, 1, // over
    0, // out
    2 // down
    );
