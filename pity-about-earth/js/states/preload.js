class PreloadState extends Phaser.State {
  preload() {
    ...
    this.game.load.image('healthbar', 'images/big/healthbar.png'); // Sprite sheets
    ...
    this.game.load.image('gelatin-font', 'images/big/gelatin-font.png'); // audio
