class MenuState extends Phaser.State {
  create() {
    ...
    this.story = [`${username}, listen up. This is`, `the Universe. I am sick of`, `your incessant nosing about.`, `The incoming asteroid should`, `resolve matters.`, `       -- Yours, the Universe`, ``, `(Protect Earth while escape`, `shuttles... well, escape)`, ``, `       -- Yours, the Universe` // `The universe, growing tired of`,
    ...
    const btnHum = this.game.add.button(this.game.world.centerX, this.game.world.height - 130, 'btn-play', this.next, this, 1, // over
    0, // out
    2 // down
    );
